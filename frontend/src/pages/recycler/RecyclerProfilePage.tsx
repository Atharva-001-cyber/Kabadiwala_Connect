...
export const RecyclerProfilePage: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-20 text-slate-100">
      {/* Header Profile Card */}
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-slate-800">
          <div className="flex items-center gap-5">
            <div className="w-18 h-18 sm:w-20 sm:h-20 rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center text-white text-3xl sm:text-4xl font-black shadow-2xl shrink-0 border border-blue-400/30">
              🏭
            </div>
            <div className="space-y-1">
              <div className="flex flex-wrap items-center gap-2.5">
                <h1 className="text-xl sm:text-2xl font-black text-white">{activeProfile.facilityName}</h1>
                <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 text-xs font-bold border border-emerald-500/30 inline-flex items-center gap-1">
                  <ShieldCheck className="w-3.5 h-3.5" />
                  <span>CPCB Gazette Verified (EPR Compliant)</span>
                </span>
              </div>
              <p className="text-xs sm:text-sm font-mono text-blue-400 font-bold tracking-wide">
                Reg No: {activeProfile.registrationNo || 'CPCB/EWR/UP/LKO/2023/5521'}
              </p>
              <p className="text-xs text-slate-400">
                Authorized Capacity: <b className="text-emerald-400">4,800 MTA</b> • Central Pollution Control Board (CPCB) Rule 13 Registered
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2.5 bg-slate-800 hover:bg-slate-700 active:scale-95 text-white font-bold rounded-2xl text-xs border border-slate-700 flex items-center gap-2 shadow transition-all"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 active:scale-95 text-white font-bold rounded-2xl text-xs shadow-lg flex items-center gap-2 transition-all"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-6 text-xs">
          ...
          <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800/90 space-y-2">
            ...
            <div>
              <span className="font-black text-white text-sm block">{activeProfile.contactPerson || 'Arun Bhatia'}</span>
              <span className="text-xs font-mono font-semibold text-emerald-400 flex items-center gap-1 mt-0.5">
          ...
          <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800/90 space-y-2">
            ...
            <div>
              <span className="font-bold text-white text-xs block line-clamp-2">
              ...
              <span className="inline-block mt-1 px-2 py-0.5 rounded bg-blue-950/80 text-blue-300 text-[9px] font-bold border border-blue-800">
                Weighbridge Active
              </span>
            </div>
          </div>
          ...
          <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800/90 space-y-2">
            ...
            <div>
              ...
              <span className="text-xs text-slate-300 block mt-0.5">
                Service Radius: <b className="text-white">{activeProfile.serviceRadiusKm || 50} km</b>
              </span>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
          ...
          <button
            type="button"
            onClick={openEditModal}
            className="px-3.5 py-1.5 bg-slate-950 hover:bg-slate-800 text-emerald-400 border border-emerald-800/60 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all self-start sm:self-auto"
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
          {ALL_CATEGORIES.map((cat) => {
            ...
            return (
              <div 
                key={cat}
                className="bg-slate-950 p-4 rounded-2xl border border-slate-800/90 flex flex-col justify-between space-y-2 hover:border-slate-700 transition-all"
              >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl space-y-4">
        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
          ...
          <span className="px-3 py-1 bg-emerald-950 text-emerald-300 text-xs font-bold rounded-xl border border-emerald-800">
            EPR Grade A
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 text-xs">
          <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 space-y-1">
            ...
            <span className="text-xl font-black text-white">4,800 MTA</span>
          ...
          <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 space-y-1">
            ...
            <span className="text-xl font-black text-emerald-400">~85.2 MT CO2e</span>
          ...
          <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 space-y-1">
            ...
            <span className="text-xl font-black text-teal-400">96.4%</span>
          ...
          <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 space-y-1">
            ...
            <span className="text-xl font-black text-blue-400">100% Traceable</span>
      ...
      {showEditModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="relative w-full max-w-xl bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl text-xs space-y-5 my-8">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div className="flex items-center gap-2">
                <Edit3 className="w-5 h-5 text-emerald-400" />
                <h3 className="text-base font-black text-white">Edit Facility Profile & Base Rates</h3>
              </div>
              <button
                type="button"
            ...
            <form onSubmit={handleSaveProfile} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block font-bold text-slate-300 mb-1">Contact Officer Name</label>
                  <input
                    type="text"
                    value={editPerson}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block font-bold text-slate-300 mb-1">Service Radius (km)</label>
                  <input
                    type="number"
                    min="5"
                    max="500"
                ...
                <div>
                  <label className="block font-bold text-slate-300 mb-1">Doorstep Pickup Available</label>
                  <select
              ...
              <div className="border-t border-slate-800 pt-3 space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                  {ALL_CATEGORIES.map((cat) => (
                    <div key={cat} className="bg-slate-950 p-2 rounded-xl border border-slate-800">
                      ...
                      <div className="flex items-center gap-1 mt-1">
                        ...
                        <input
                          ...
                          className="w-full p-1 bg-slate-900 border border-slate-700 rounded text-emerald-400 font-black text-xs text-center focus:outline-none focus:border-emerald-500"
                          required
                        />
                      </div>
                    </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-800">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 active:scale-95 text-white font-black rounded-xl shadow-lg flex items-center gap-2 transition-all disabled:opacity-50"
                >
                  {saving ? (
