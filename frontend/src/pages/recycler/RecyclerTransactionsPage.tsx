  ...
  return (
    <div className="space-y-6 pb-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-400 font-medium mt-1">
              Facility: <b className="text-emerald-400">{facilityName}</b> • CPCB E-Waste Rule 19 Double-Entry Accounting
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="px-3.5 py-2 bg-slate-800 hover:bg-slate-700 active:scale-95 text-slate-200 border border-slate-700 rounded-xl text-xs font-bold flex items-center gap-1.5 shadow transition-all disabled:opacity-50"
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 sm:p-6 shadow-xl space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          <div>
            <h2 className="text-sm font-extrabold uppercase tracking-wider text-slate-300 flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 rounded-full bg-slate-800 text-slate-400 font-mono text-xs">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs">
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-3 py-1.5 bg-slate-950 border border-slate-800 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 text-xs w-44 sm:w-56"
              />
            </div>
            ...
            <div className="flex items-center bg-slate-950 p-1 rounded-xl border border-slate-800">
              <button
                ...
                className={`px-2.5 py-1 rounded-lg font-bold transition-all ${
                  paymentFilter === 'ALL' ? 'bg-emerald-600 text-white' : 'text-slate-400 hover:text-white'
                }`}
              >
                All
              </button>
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-lg font-bold transition-all ${
                  paymentFilter === 'UPI' ? 'bg-emerald-600 text-white' : 'text-slate-400 hover:text-white'
                }`}
              >
                UPI / Voucher
              </button>
        ...
        {loading ? (
          <div className="bg-slate-950 rounded-2xl p-12 text-center space-y-3 border border-slate-800">
          ...
          <div className="space-y-3">
            {filteredTransactions.map((tx) => (
              <div
                key={tx.id}
                className="bg-slate-950 border border-slate-800/80 hover:border-slate-700/90 p-4 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs transition-all"
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-blue-950/80 text-blue-400 flex items-center justify-center font-bold shrink-0 border border-blue-900/40">
                  ...
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {scope === 'ALL_NETWORK' && tx.recyclerName && (
                        <span className="text-[10px] px-2 py-0.5 rounded bg-purple-950/60 text-purple-300 border border-purple-800">
                          {tx.recyclerName}
                        </span>
                      )}
                    </div>
                ...
                <div className="flex items-center gap-3 self-end sm:self-center">
                  <div className="text-right">
                    ...
                    <span className="text-[10px] text-emerald-300 font-bold bg-emerald-950 px-2 py-0.5 rounded border border-emerald-800 inline-block mt-0.5">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-emerald-700 hover:bg-emerald-600 active:scale-95 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 shadow transition-all disabled:opacity-50"
