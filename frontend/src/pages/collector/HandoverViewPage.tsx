  ...
  return (
    <div className="max-w-xl mx-auto space-y-6 pb-20">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs font-mono font-bold text-emerald-400">{lot.id}</span>
      </div>
      ...
      <div className="bg-slate-900 border-2 border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 relative overflow-hidden">
        <div className="text-center space-y-2 border-b border-slate-800 pb-5">
          <div className="w-16 h-16 bg-emerald-950 text-emerald-400 rounded-2xl flex items-center justify-center mx-auto border-2 border-emerald-800 shadow-lg">
            <Scale className="w-8 h-8" />
          </div>
          <h1 className="text-2xl font-black text-white">{t.handoverTitle}</h1>
        ...
        <div className="bg-gradient-to-br from-emerald-950 via-slate-950 to-emerald-950 border-2 border-emerald-500 rounded-3xl p-6 text-center space-y-2 shadow-2xl">
          <span className="text-xs font-black uppercase tracking-wider text-emerald-400 block">
            {t.handoverOtp}
          </span>
          <div className="font-mono text-4xl sm:text-5xl font-black text-white tracking-widest py-2">
        ...
        <div className="bg-slate-950 rounded-2xl p-4 sm:p-5 border border-slate-800 text-xs space-y-3 shadow-inner">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="bg-slate-900 p-3.5 rounded-xl border border-slate-800">
              ...
              <span className="font-black text-white text-lg mt-0.5 block">{lot.approxWeight} kg</span>
            </div>
            ...
            <div className="bg-slate-900 p-3.5 rounded-xl border border-slate-800">
              ...
              <span className="font-black text-emerald-400 text-lg mt-0.5 block">
          ...
          {handover && (
            <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-[11px] flex items-center justify-between">
              <span className="text-slate-400 font-medium">{language === 'hi' ? 'वजन अंतर:' : language === 'mr' ? 'वजन फरक:' : 'Tare Variance:'}</span>
              <span className={`font-black ${weightDiff >= 0 ? 'text-emerald-400' : 'text-amber-400'}`}>
        ...
        {pickup && (
          <div className="bg-slate-950 rounded-2xl p-4 border border-slate-800 text-xs space-y-2.5">
            <div className="flex items-center justify-between text-slate-400 font-bold border-b border-slate-800/80 pb-2">
              ...
              <span className="px-2 py-0.5 rounded-full bg-purple-950 text-purple-300 text-[10px] font-black border border-purple-800">
        ...
        {handover?.signatureImageUrl && (
          <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 text-xs space-y-2">
            ...
            <div className="bg-slate-900/90 p-2 rounded-xl border border-slate-700/60 inline-block">
              <img
        ...
        {handover && (
          <div className="bg-gradient-to-br from-slate-950 to-emerald-950/40 p-4 rounded-2xl border border-emerald-500/50 space-y-2">
            <div className="flex items-center justify-between">
              <div>
              ...
              <span className="px-3 py-1 bg-emerald-950 text-emerald-300 text-xs font-black rounded-xl border border-emerald-800">
        ...
        <button
          ...
          className="w-full min-h-[56px] py-4 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-black text-sm rounded-2xl shadow-xl flex items-center justify-center gap-2 active:scale-95 transition-all"
        >
